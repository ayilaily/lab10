...
let sum8 = lab8[0] + lab8[1] + lab8[2] + lab8[3] + lab8[4];

let sums = [sum1, sum2, sum3, sum4_5, sum6, sum8];
avg_labs_score = (sum1 + sum2 + sum3 + sum4_5 + sum6 + sum8)/7;
quiz_score = 32;
console.log(sums);
...
sums: [sum1, sum2, sum3, sum4_5, sum6, sum8], // array of sums of each lab
